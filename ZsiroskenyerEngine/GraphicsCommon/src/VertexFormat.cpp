...
void cVertexFormat::SetAttribute(eVertexAttribute attrib, bool value) {
	value ? AddAttribute(attrib) : ClearAttribute(attrib);
}

void cVertexFormat::AddAttribute(eVertexAttribute attrib) {
	attribs |= (unsigned)attrib;
}

void cVertexFormat::ClearAttribute(eVertexAttribute attrib) {
