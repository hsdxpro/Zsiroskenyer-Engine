...
const ID3D11ShaderResourceView* cTexture2DD3D11::GetSRV() const {
	return srv;
}

const ID3D11RenderTargetView* cTexture2DD3D11::GetRTV() const {
	return rtv;
}

const ID3D11DepthStencilView* cTexture2DD3D11::GetDSV() const {
	return dsv;
}