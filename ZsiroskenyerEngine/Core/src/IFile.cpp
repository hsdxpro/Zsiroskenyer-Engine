...
bool IFile::ReadBinary(const zsString& path, void* data_out, const size_t& dataSize) {
	return cFile::ReadBinary(path, data_out, dataSize);
}

bool IFile::WriteBinary(const zsString& path, void* data, const size_t& dataSize) {
